...
export function WhatsAppFloat() {
    const whatsappUrl = 'https://api.whatsapp.com/send/?phone=919737828614&text=Hello+Aura+House+of+Flowers%2C+I+would+like+to+discuss+a+project.&type=phone_number&app_absent=0'
