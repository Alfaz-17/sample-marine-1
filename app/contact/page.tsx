        ...
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-24">
          ...
          <div className="lg:col-span-7">
            <form className="space-y-12">
              ...
              <button
                type="submit"
                className="w-full md:w-auto px-12 py-5 bg-foreground text-background text-[11px] uppercase tracking-[0.3em] font-bold hover:bg-foreground/90 transition-all"
              >
                Send Inquiry
              </button>
